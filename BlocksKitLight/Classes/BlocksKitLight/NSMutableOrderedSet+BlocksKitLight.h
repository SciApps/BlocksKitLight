//
//  NSMutableOrderedSet+BlocksKitLight.h
//  BlocksKitLight
//
...
/** Block extensions for NSMutableOrderedSet.
 ...
 @see NSOrderedSet(BlocksKitLight)
 */
@interface BKL_GENERICS(NSMutableOrderedSet, ObjectType) (BlocksKitLight)

/** Filters a mutable ordered set to the objects matching the block.

 @param block A single-argument, BOOL-returning code block.
 @see <NSOrderedSet(BlocksKitLight)>bkl_reject:
 */
- (void)bkl_performSelect:(BOOL (^)(id ObjectType))block;

/** Filters a mutable ordered set to all objects but the ones matching the
 block, the logical inverse to bkl_select:.

 @param block A single-argument, BOOL-returning code block.
 @see <NSOrderedSet(BlocksKitLight)>bkl_select:
 */
...
/** Transform the objects in the ordered set to the results of the block.
 ...
 @see <NSOrderedSet(BlocksKitLight)>bkl_map:
 */
