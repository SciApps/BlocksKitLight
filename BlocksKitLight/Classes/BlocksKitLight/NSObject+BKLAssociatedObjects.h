//
//  NSObject+BKLAssociatedObjects.h
//  BlocksKitLight
//
...
/** Objective-C wrapper for 10.6+ associated object API.
 ...
 `AMAssociatedObjects`.
 */
@interface NSObject (BKLAssociatedObjects)
 ...
 */
- (void)bkl_associateValue:(nullable id)value withKey:(const void *)key;
...
/** Strongly, thread-safely associates an object with the reciever.
 ...
 @param key A unique key pointer.
 */
- (void)bkl_atomicallyAssociateValue:(nullable id)value withKey:(const void *)key;
...
/** Associates a copy of an object with the reciever.
 ...
 @param key A unique key pointer.
 */
- (void)bkl_associateCopyOfValue:(nullable id)value withKey:(const void *)key;
...
/** Thread-safely associates a copy of an object with the reciever.
 ...
 @param key A unique key pointer.
 */
- (void)bkl_atomicallyAssociateCopyOfValue:(nullable id)value withKey:(const void *)key;
...
/** Weakly associates an object with the reciever.
 ...
 @param key A unique key pointer.
 */
- (void)bkl_weaklyAssociateValue:(nullable __autoreleasing id)value withKey:(const void *)key;
 ...
 */
- (nullable id)bkl_associatedValueForKey:(const void *)key;
