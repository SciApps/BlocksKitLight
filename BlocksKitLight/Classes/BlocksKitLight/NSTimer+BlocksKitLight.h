...
*/
@interface NSTimer (BlocksKitLight)
 ...
 * @return A new @c NSTimer object, configured according to the specified parameters.
 */
+ (instancetype)bkl_timerWithTimeInterval:(NSTimeInterval)seconds repeats:(BOOL)repeats usingBlock:(void (^)(NSTimer *timer))block;

@end

@interface NSTimer (BlocksKitLight_Deprecated)

+ (instancetype)bkl_scheduledTimerWithTimeInterval:(NSTimeInterval)seconds block:(void (^)(NSTimer *timer))block repeats:(BOOL)repeats DEPRECATED_MSG_ATTRIBUTE("Replaced with -bkl_performAfterDelay:usingBlock:");
+ (instancetype)bkl_timerWithTimeInterval:(NSTimeInterval)seconds block:(void (^)(NSTimer *timer))block repeats:(BOOL)repeats DEPRECATED_MSG_ATTRIBUTE("Replaced with -bkl_performAfterDelay:usingBlock:");
